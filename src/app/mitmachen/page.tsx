        ...
        <div className="mx-auto max-w-5xl px-4 md:px-8">
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="flex flex-col gap-4 rounded-sm border-l-4 border-[#58b046] bg-[#f8f8fa] p-6">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1.5 rounded-sm bg-gradient-to-r from-[#833ab4] via-[#fd1d1d] to-[#fcb045] px-3 py-1.5 text-xs font-semibold text-white transition-opacity hover:opacity-90"
                >
                  Instagram folgen
                </a>
                <button
            ...
            <div className="flex flex-col gap-4 rounded-sm border-l-4 border-[#58b046] bg-[#f8f8fa] p-6">
              ...
              <p className="flex-1 text-sm leading-relaxed text-[#6b6b7b]">
                42 Vorhaben f&uuml;r 8 Jahre &ndash; w&auml;hlen Sie Ihre Top 10 und
        ...
        <div className="mx-auto max-w-3xl px-4 text-center md:px-8">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 rounded-sm bg-gradient-to-r from-[#833ab4] via-[#fd1d1d] to-[#fcb045] px-5 py-3 text-sm font-semibold text-white transition-opacity hover:opacity-90"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
